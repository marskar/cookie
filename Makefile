...
.git/:
	curl --user 'marskar' https://api.github.com/user/repos --data '{"name":"cookie","description":"Automate creation of figures, models, and plots with GNU Make."}'
	test -f README.rst || echo "cookie" >> README.rst
	git init
	git add --all
	git commit --message "First commit"
	git remote add origin https://github.com/marskar/cookie.git
